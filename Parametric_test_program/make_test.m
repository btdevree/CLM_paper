...
%   v1.1 - add completed_flags matrix, adjust region values,...
...
% Create the completed_flags matrix
completed_flags = false(total_number_images, 1);
...
save(pathname, 'GUI_info', 'completed_flags');
