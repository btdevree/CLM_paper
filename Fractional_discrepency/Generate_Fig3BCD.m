...
% Get the IIC results
[IIC_results, experimental_discrepency_results, ideal_discrepency_results] = generate_IIC_curve(params, fraction_vector, number_events_vector,...
    SNratio, number_replicates, number_pseudoreplicates, 'l2_norm', ideal_image, true, true);
...
% Save data
filename = [figure_path, 'Fig3B_L2_IIC_data.mat'];
save(filename, 'fraction_vector', 'number_events_vector', 'number_replicates', 'number_pseudoreplicates', 'IIC_mean', 'IIC_stdev',...
    'IIC_results', 'experimental_discrepency_results', 'ideal_discrepency_results');

% Make figure
filename = [figure_path, 'Fig3B_L2_IIC_graph.png'];
