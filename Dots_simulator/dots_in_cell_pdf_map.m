function [ pdf_map, center_coords, STORM_mask] = dots_in_cell_pdf_map(number_of_dots, dot_radius, dot_to_background_ratio, parameter_struct)
%DOTS_IN_CELLPDF_MAP Makes a pdf map of circular regions with uniform 
%   density inside the main cell density of a simulated movie dataset.
%
